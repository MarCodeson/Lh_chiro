  ...
  return (
    <Section id="testimonials">
      ...
      >
        ...
        <p className="small">Auto-scrolls every 5 seconds. Pause on hover or focus.</p>
      </motion.div>
      <div
          ...
          <AnimatePresence initial={false} custom={direction}>
            ...
            >
              ...
              <div className="flex flex-col">
                <blockquote className="text-lg text-neutral-900">{current.quote}</blockquote>
                <div className="mt-3 text-base font-medium text-neutral-700">{current.author}</div>
      ...
      <p className="small mt-2">Testimonials collected via direct feedback and referral notes.</p>
    </Section>
  )
}
