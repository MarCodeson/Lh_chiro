...
const STEPS = [
  {
    ...
    description: 'Share your goals, case history, and preferred clinic location for context.',
  },
  {
    title: 'Clinical review',
    description: 'Assessment of joints, soft tissue, movement, and contributing stress patterns.',
  },
  {
    title: 'Ongoing collaboration',
    description: 'Agree next steps, home practices, and progress reviews without obligation.',
  },
] as const
