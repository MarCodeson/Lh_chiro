...
export function Locations() {
  ...
  return (
    <Section id="locations">
      ...
      >
        <h2 className="text-2xl font-semibold">Clinics & outreach</h2>
      </motion.div>
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-3 p-5">
              ...
              <div className="mt-auto pt-4">
                <a
                  href={`#contact?location=${loc.key}`}
                  className="btn w-full border border-accent/30 text-sm text-accent hover:border-accent"
                >
